...
| **Probe 133** | **Refined calm zone LR (13 features, per-channel)** | **AUROC** | **Strict=0.734 (NEW RECORD!); Standard=0.630 (worse)** | TF=0.723; LR4=0.703 | **COMPLETE - LR 0.734 > TF 0.723 (point estimate); CIs overlap; channels anti-correlated in calm zone** |
