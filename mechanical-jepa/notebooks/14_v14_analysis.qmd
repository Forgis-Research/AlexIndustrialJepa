...
See `experiments/v14/full_sequence_prediction.json`. At the time of writing, probe RMSE on val during pretraining reached 14.10 (V2 baseline probe best was ~10.3 at val; numbers differ in protocol but indicate the encoder is learning meaningful features). Test-set fine-tuning numbers pending.
