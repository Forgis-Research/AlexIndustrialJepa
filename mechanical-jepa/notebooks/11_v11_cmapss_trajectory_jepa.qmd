...
FD002 has 260 training engines (vs 100 for FD001), single fault mode but 6 operating
conditions. Per-condition normalization is used. STAR supervised SOTA on FD002 = 13.47.

| Method | 100% | 50% | 20% | 10% | Notes |
|:-------|:----:|:---:|:---:|:----:|:------|
| Traj JEPA frozen (FD002) | see RESULTS.md | - | - | - | V2 architecture |
| Traj JEPA E2E (FD002) | see RESULTS.md | - | - | - | V2 architecture |
| STAR supervised (FD002) | 13.47 | - | - | - | Paper result |

Full FD002 results in RESULTS.md after overnight run completes.
...
Cross-transfer FD002->FD001 E2E @ 10%: see RESULTS.md.
...
|:-------|:----:|:---------:|
| JEPA E2E (V2) | 13.80 | see RESULTS.md |
| LSTM supervised | 17.36 | see RESULTS.md |
...
3. **Operating condition generalization**: We only tested FD001 (single condition).
   FD002/FD004 with 6 conditions require per-condition normalization and likely
   different hyperparameters. Results are preliminary.
